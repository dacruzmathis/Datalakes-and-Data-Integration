...
def run():
    account_name = os.getenv('STORAGE_ACCOUNT_NAME', "storageaccountpython1")
    account_key = os.getenv('STORAGE_ACCOUNT_KEY', "1Sclf7MaN1j8Vf9fgshzc2eUoQ+bcIhhuiPPFAkYNRPatVU1J7Jqn5cPrUlPSD+oOYQjwPGaVvJy+AStTMARPw==")
